          ...
          <main>
            ...
            >
              <div className={about.story}>
                ...
                <div className={about.storyPart}>
                  <h2 className="body-2-m text-low-emphasis">Proof of Concept</h2>
                ...
                <div className={about.storyPart}>
                  ...
                  <p className="body-1-s text-medium-emphasis">During our cooldown week of April, Yann-Edern took the initiative to transform this POC into something that can be shared on the Internets. He also made it more on-brand, improved the prompt sent to GPT-3, and leveraged Vercel Edge Functions, thanks to <Link className="text-info" href="https://vercel.com/blog/gpt-3-app-next-js-vercel-edge-functions" target="_blank">this brilliant article ↗︎</Link> from Hassan El Mghari.</p>
                </div>
              </div>
              <motion.div
              ...
              >
                ...
                <div className={about.information}>
                  <div className={about.stackTitle}>
                    ...
                    <Link className="body-2-s text-info" href="https://github.com/yannglt/not-boring-ds-names" target="_blank">View code ↗︎</Link>
                  </div>
