          ...
          <div className={styles.links}>
            <ul className={styles.list}>
              <li className={styles.listItem}>
                <Link href="/" className="body-2-m text-medium-emphasis">
                  Index
                </Link>
              </li>
              <li className={styles.listItem}>
                <Link href="/about" className="body-2-m text-medium-emphasis">
                  About
                </Link>
              </li>
              <li className={styles.listItem}>
            ...
            >
              {menu ? (
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M6.1109 5.05024C5.818 4.75734 5.34313 4.75734 5.05024 5.05024C4.75734 5.34313 4.75734 5.818 5.05024 6.1109L8.93932 9.99998L5.05024 13.8891C4.75734 14.182 4.75734 14.6568 5.05024 14.9497C5.34313 15.2426 5.818 15.2426 6.1109 14.9497L9.99998 11.0606L13.8891 14.9497C14.182 15.2426 14.6568 15.2426 14.9497 14.9497C15.2426 14.6568 15.2426 14.182 14.9497 13.8891L11.0606 9.99998L14.9497 6.1109C15.2426 5.818 15.2426 5.34313 14.9497 5.05024C14.6568 4.75734 14.182 4.75734 13.8891 5.05024L9.99998 8.93932L6.1109 5.05024Z"
                />
              ) : (
                <path
                  fillRule="evenodd"
